 ...
 * 13 jan 2017
 */
package da222mz_assign1.Exercise_7;
...
public class CountrySort {
	...
	public static void main(String[] args) {
		...
		Comparator<String> longestName = (s1,s2) -> s2.length()-s1.length(); //Updated!!!1!
		...
		Comparator<String> reverseAlphabetic = (s1,s2) -> s2.compareTo(s1); //Updated!!!1!
		Arrays.sort(COUNTRIES,reverseAlphabetic);
		System.out.println("\nTop 10 list of countries in reverse alphabetic order");
		for (int i=0; i<10;i++)
			System.out.println("\t"+COUNTRIES[i]);
		...
		Comparator<String> countAs = (s1,s2) -> {
			Function<String,Integer> aInString = (s) -> {
				int count = 0;
			...
			return aInString.apply(s2)-aInString.apply(s1);
		};		//Updated!!!1!
